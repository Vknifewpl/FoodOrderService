...
public class AiService {
        ...
        public JSONObject chat(String userMessage, List<Long> cartFoodIds, List<Map<String, String>> chatHistory) {
                ...
                String sys = "你是「智味助手」，一个专业的点餐推荐AI。你必须严格遵守以下规则：\n"
                                ...
                                + "【必须推荐菜品的情况】\n"
                                + "8. 当用户询问菜品推荐、想吃什么、有什么推荐时，必须返回recommendFoodId\n"
                                + "9. 当用户提到口味偏好（如辣的、甜的、酸的、清淡、冰的、热等）时，必须返回recommendFoodId\n"
                                + "10. 当用户提到菜品分类（如主食、热菜、凉菜、汤羹、饮品等）时，必须返回recommendFoodId\n"
                                + "11. 当用户表达想吃某种类型的食物时，必须返回recommendFoodId\n"
                                + "12. 当用户拒绝之前的推荐时，必须返回新的recommendFoodId\n"
                                + "【可以不推荐菜品的情况】\n"
                                + "13. 当用户只是打招呼（如你好、嗨）、感谢（如谢谢、感谢）、闲聊时，recommendFoodId可以为null\n"
                                + "【菜单】(ID:名称:分类:价格)\n" + menu.context
                                + "\n【购物车】" + cartInfo
                                + excludeInfo
