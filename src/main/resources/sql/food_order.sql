...
INSERT INTO `comment` VALUES (62, 1, 6, 3, '一般', 5, '2026-03-06 10:09:02', 0);
INSERT INTO `comment` VALUES (63, 1, 30, 3, '11111', 5, '2026-03-06 10:09:12', 0);
INSERT INTO `comment` VALUES (64, 1, 2, 1, '', 1, '2026-03-06 10:24:23', 1);
INSERT INTO `comment` VALUES (65, 1, 16, 1, '', 1, '2026-03-06 10:24:23', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '菜品表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `food` VALUES (6, '兰州拉面', 1, 15.00, '汤清、萝卜白、辣油红、香菜绿、面黄。', '/images/food6.jpg', 253, 231, '2026-03-04 20:27:53', '2026-03-06 11:52:31', 0);
...
INSERT INTO `food` VALUES (30, '酸辣粉', 8, 15.00, '红薯粉Q弹爽滑，酸辣过瘾，经典街头小吃。', '/images/food30.png', 254, 241, '2026-03-05 01:00:00', '2026-03-06 11:52:31', 0);
INSERT INTO `food` VALUES (31, '1', 7, 0.00, '1', '/images/44fdaeb4e8664665883295c89aa480ce.png', 0, 0, '2026-03-10 00:10:54', '2026-03-10 00:11:31', 0);
...
CREATE TABLE `order_item`  (
  ...
  INDEX `idx_food_id`(`food_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '订单明细表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `order_item` VALUES (12, 4, 'ORD202603061121331CA163', 30, '酸辣粉', '/images/food30.png', 15.00, 1, 15.00, '2026-03-06 11:21:33');
INSERT INTO `order_item` VALUES (13, 5, 'ORD202603061152319C2BB8', 30, '酸辣粉', '/images/food30.png', 15.00, 1, 15.00, '2026-03-06 11:52:32');
INSERT INTO `order_item` VALUES (14, 5, 'ORD202603061152319C2BB8', 6, '兰州拉面', '/images/food6.jpg', 15.00, 1, 15.00, '2026-03-06 11:52:32');
...
INSERT INTO `orders` VALUES (4, 'ORD202603061121331CA163', 2, 15.00, 1, '2026-03-06 11:21:33', '2026-03-06 11:21:33', NULL, '2026-03-06 11:21:33', '2026-03-06 11:21:33', 0);
INSERT INTO `orders` VALUES (5, 'ORD202603061152319C2BB8', 1, 30.00, 4, '2026-03-06 11:52:32', '2026-03-06 11:58:40', '2026-03-06 11:59:16', '2026-03-06 11:52:32', '2026-03-06 11:52:32', 0);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'user', 'e10adc3949ba59abbe56e057f20f883e', 0, 'eyJhbGciOiJIUzUxMiJ9.eyJyb2xlIjowLCJleHAiOjE3NzMxNTkxNTUsInVzZXJJZCI6MSwiaWF0IjoxNzczMDcyNzU1LCJ1c2VybmFtZSI6InVzZXIifQ.QUDd2CpqU-IYlTrK4K0E-ZY3IXwVF-g-fZ3m0v9CjR3_KyoaWfMhG-UzULHyFE5LjwHehbjo6E95W9R07_aOhw', 0, '2026-02-25 18:53:26', '2026-03-10 00:12:35', 0);
INSERT INTO `user` VALUES (2, 'mer', 'e10adc3949ba59abbe56e057f20f883e', 1, 'eyJhbGciOiJIUzUxMiJ9.eyJyb2xlIjoxLCJleHAiOjE3NzMxNTkwODQsInVzZXJJZCI6MiwiaWF0IjoxNzczMDcyNjg0LCJ1c2VybmFtZSI6Im1lciJ9.V0Xz0PNunYJR5p2h6PhFORnS6oP_MbkCPo5dGDWWCPSE3MnOvE3plHiBWK-IVouxRWLR3tibBU7ODW4mZgx60w', 0, '2026-02-25 18:57:43', '2026-03-10 00:11:24', 0);
...
INSERT INTO `user` VALUES (4, 'test', 'e10adc3949ba59abbe56e057f20f883e', 0, 'eyJhbGciOiJIUzUxMiJ9.eyJyb2xlIjowLCJleHAiOjE3NzMxNTUxMjMsInVzZXJJZCI6NCwiaWF0IjoxNzczMDY4NzIzLCJ1c2VybmFtZSI6InRlc3QifQ.OXZzM4D1eXdgTDeQ2C7Fp9VEM-XGJ4elbf-SGgjDBf9L-RS2-_iAynWDSdz46mnhGZbgr5sL-gvFCwYTZngydA', 1, '2026-03-09 22:57:36', '2026-03-09 23:05:23', 0);
INSERT INTO `user` VALUES (5, 'adm', 'e10adc3949ba59abbe56e057f20f883e', 2, 'eyJhbGciOiJIUzUxMiJ9.eyJyb2xlIjoyLCJleHAiOjE3NzMxNTcyNjEsInVzZXJJZCI6NSwiaWF0IjoxNzczMDcwODYxLCJ1c2VybmFtZSI6ImFkbSJ9.onvgfGjYgQbTXiFrKBkCeZVAnHtVCb5uXA8v3HUPRcD9q4f5Zz8v9aYXre9B3i6bZGihkAQr2nQddGRgK1eyxQ', 0, '2026-03-09 23:11:24', '2026-03-09 23:41:01', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户偏好表(协同过滤算法)' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of user_preference
-- ----------------------------
INSERT INTO `user_preference` VALUES (1, 3, 8, 0.00, 0, 0, NULL, '2026-03-04 21:55:44', '2026-03-04 21:55:44');
INSERT INTO `user_preference` VALUES (2, 1, 2, 7.00, 2, 0, 1, '2026-03-05 01:20:12', '2026-03-05 01:20:12');
INSERT INTO `user_preference` VALUES (3, 1, 21, 10.00, 2, 0, 4, '2026-03-05 01:20:12', '2026-03-05 01:20:12');
INSERT INTO `user_preference` VALUES (4, 1, 16, 4.00, 1, 0, 1, '2026-03-05 01:20:12', '2026-03-05 01:20:12');
INSERT INTO `user_preference` VALUES (5, 1, 5, 5.00, 1, 1, NULL, '2026-03-05 01:29:32', '2026-03-05 01:29:32');
INSERT INTO `user_preference` VALUES (6, 1, 30, 14.00, 3, 0, 5, '2026-03-05 01:29:32', '2026-03-05 01:29:32');
INSERT INTO `user_preference` VALUES (7, 1, 6, 14.00, 3, 0, 5, '2026-03-05 01:29:32', '2026-03-05 01:29:32');
...
INSERT INTO `user_preference` VALUES (10, 2, 30, 3.00, 1, 0, NULL, '2026-03-06 11:21:33', '2026-03-06 11:21:33');
