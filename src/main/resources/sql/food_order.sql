...
-- Records of comment
-- ----------------------------
INSERT INTO `comment` (`user_id`, `food_id`, `order_id`, `content`, `rating`, `create_time`) VALUES 
(1, 1, 1, '鸡肉非常嫩，花生米也很脆，味道正宗！', 5, '2026-03-05 01:10:00'),
(2, 1, 1, '稍微有一点点点辣，不过味道整体很棒。', 4, '2026-03-05 01:15:00'),
(3, 2, 2, '红烧肉肥而不腻，分量很足，推荐！', 5, '2026-03-05 01:20:00'),
(1, 2, 2, '非常下饭，肉炖得很烂。', 5, '2026-03-05 01:25:00'),
(2, 3, 3, '鱼香肉丝的味道调得刚刚好，酸甜适口。', 5, '2026-03-05 01:30:00'),
(3, 3, 3, '分量不错，配菜也新鲜。', 4, '2026-03-05 01:35:00'),
(1, 4, 4, '麻婆豆腐真的很麻很辣，爽！', 5, '2026-03-05 01:40:00'),
(2, 4, 4, '这道菜配米饭简直绝了。', 5, '2026-03-05 01:45:00'),
(1, 5, 5, '炒饭颗粒分明，料很多，很实惠。', 5, '2026-03-05 01:50:00'),
(3, 5, 5, '火候掌握得很好，香气四溢。', 4, '2026-03-05 01:55:00'),
(2, 6, 6, '面条很有韧性，汤底清亮鲜美。', 5, '2026-03-05 02:00:00'),
(1, 6, 6, '分量很足，兰州风味很正。', 5, '2026-03-05 02:05:00'),
(3, 7, 7, '酱香味浓郁，面条筋道，很好吃。', 5, '2026-03-05 02:10:00'),
(1, 7, 7, '老北京的味道，炸酱很地道。', 4, '2026-03-05 02:15:00'),
(2, 8, 8, '口感清爽，解腻神器。', 5, '2026-03-05 02:20:00'),
(3, 8, 8, '黄瓜很脆，蒜香味挺浓。', 4, '2026-03-05 02:25:00'),
(1, 9, 9, '麻辣鲜香，肉质软嫩，强烈推荐。', 5, '2026-03-05 02:30:00'),
(2, 9, 9, '味道很正，辣油特别香。', 5, '2026-03-05 02:35:00'),
(3, 10, 10, '很平淡但很舒服的一碗汤。', 5, '2026-03-05 02:40:00'),
(1, 10, 10, '西红柿和鸡蛋分量都很多。', 4, '2026-03-05 02:45:00'),
(2, 11, 11, '汤头很浓，骨头上的肉很好啃。', 5, '2026-03-05 02:50:00'),
(3, 11, 11, '感觉很有营养，清淡不腻。', 5, '2026-03-05 02:55:00'),
(1, 12, 12, '西米Q弹，芒果味浓郁，好喝！', 5, '2026-03-05 03:00:00'),
(2, 12, 12, '甜度刚好，解暑利器。', 5, '2026-03-05 03:05:00'),
(3, 13, 13, '奶茶味很纯正，珍珠很有嚼劲。', 5, '2026-03-05 03:10:00'),
(1, 13, 13, '性价比很高的一杯奶茶。', 4, '2026-03-05 03:15:00'),
(2, 14, 14, '正宗老式酸梅汤，生津止渴。', 5, '2026-03-05 03:20:00'),
(3, 14, 14, '配辣菜喝简直是一绝。', 5, '2026-03-05 03:25:00'),
(1, 15, 15, '肉片炒得很干香，辣味适中。', 5, '2026-03-05 03:30:00'),
(2, 15, 15, '经典的川菜味道，非常下饭。', 5, '2026-03-05 03:35:00'),
(3, 16, 16, '外皮金黄酥脆，里面的肉很嫩。', 5, '2026-03-05 03:40:00'),
(1, 16, 16, '蘸着番茄酱吃真的太赞了！', 5, '2026-03-05 03:45:00'),
(2, 17, 17, '煎饺底部好脆，里面的汁水多。', 5, '2026-03-05 03:50:00'),
(3, 17, 17, '个头很大，皮薄馅厚。', 4, '2026-03-05 03:55:00'),
(1, 18, 18, '香气扑鼻，口感弹润，必点。', 5, '2026-03-05 04:00:00'),
(2, 18, 18, '肉质很紧实，一点也不粉。', 5, '2026-03-05 04:05:00'),
(3, 19, 19, '炸得刚刚好，撒了盐很好吃。', 5, '2026-03-05 04:10:00'),
(1, 19, 19, '分量给得挺多的，很满意。', 4, '2026-03-05 04:15:00'),
(2, 20, 20, '鸡米花酥脆可口，一口一个停不下来。', 5, '2026-03-05 04:20:00'),
(3, 20, 20, '追剧神助手，味道棒极了。', 5, '2026-03-05 04:25:00'),
(1, 21, 21, '西瓜汁很甜，冰冰凉凉的很解渴。', 5, '2026-03-05 04:30:00'),
(2, 21, 21, '新鲜现榨的，味道很纯正。', 5, '2026-03-05 04:35:00'),
(3, 22, 22, '柠檬清新，蜂蜜清甜，推荐。', 5, '2026-03-05 04:40:00'),
(1, 22, 22, '夏天喝一杯真的太舒服了。', 5, '2026-03-05 04:45:00'),
(2, 23, 23, '芒果味非常浓厚，冰沙很细腻。', 5, '2026-03-05 04:50:00'),
(3, 23, 23, '料足味美，颜值也很高。', 4, '2026-03-05 04:55:00'),
(1, 24, 24, '椰香味十足，非常天然。', 5, '2026-03-05 05:00:00'),
(2, 24, 24, '清甜不腻口，营养又好喝。', 5, '2026-03-05 05:05:00'),
(3, 25, 25, '气泡感很足，百香果很酸爽。', 5, '2026-03-05 05:10:00'),
(1, 25, 25, '口感非常丰富，很喜欢这个气泡。', 5, '2026-03-05 05:15:00'),
(2, 26, 26, '鱼片滑嫩，红油非常香辣，带劲。', 5, '2026-03-05 05:20:00'),
(3, 26, 26, '麻辣程度适中，咸香可口。', 5, '2026-03-05 05:25:00'),
(1, 27, 27, '鸡块炸得很干，越嚼越香。', 5, '2026-03-05 05:30:00'),
(2, 27, 27, '辣椒里面找鸡丁，很有乐趣。', 4, '2026-03-05 05:35:00'),
(3, 28, 28, '食材很丰富，汤底好香。', 5, '2026-03-05 05:40:00'),
(1, 28, 28, '一个人吃这一个分量很足了。', 5, '2026-03-05 05:45:00'),
(2, 29, 29, '剁椒的味道很入味，鱼肉极鲜。', 5, '2026-03-05 05:50:00'),
(3, 29, 29, '经典的湖南味道，很下饭。', 5, '2026-03-05 05:55:00'),
(1, 30, 30, '粉很顺滑，酸辣的度刚刚好。', 5, '2026-03-05 06:00:00'),
(2, 30, 30, '配点炸黄豆和酸豆角，真的绝。', 5, '2026-03-05 06:05:00');
